...
for data in [
    ...
    {'name': 'Boston Harbor', 'description': 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.', 'place_number': '2', 'event': hmod.Event.objects.get(id=4), 'photo': 'area8.jpg'},
    {'name': 'Batlefield', 'description': 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.', 'place_number': '1', 'event': hmod.Event.objects.get(id=5), 'photo': 'area9.jpg'},
    {'name': 'Ship Dock', 'description': 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.', 'place_number': '2', 'event': hmod.Event.objects.get(id=5), 'photo': 'area10.jpg'},
]:
...
for data in [
    {'condition': 'Like New', 'late_fee': '500.00', 'due_date': '2014-12-12', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=1), 'item': hmod.Item.objects.get(id=1)},
    {'condition': 'Used', 'late_fee': '45.00', 'due_date': '2014-12-19', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=2), 'item': hmod.Item.objects.get(id=3)},
    {'condition': 'Like New', 'late_fee': '50.00', 'due_date': '2014-12-26', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=3), 'item': hmod.Item.objects.get(id=2)},
    {'condition': 'Like New', 'late_fee': '500.00', 'due_date': '2014-12-26', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=4), 'item': hmod.Item.objects.get(id=4)},
    {'condition': 'Like New', 'late_fee': '23.00', 'due_date': '2015-1-3', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=5), 'item': hmod.Item.objects.get(id=5)},
    {'condition': 'Used', 'late_fee': '56.00', 'due_date': '2015-1-3', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=6), 'item': hmod.Item.objects.get(id=7)},
    {'condition': 'Like New', 'late_fee': '576.00', 'due_date': '2015-1-3', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=7), 'item': hmod.Item.objects.get(id=6)},
    {'condition': 'Used', 'late_fee': '52.00', 'due_date': '2015-2-12', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=8), 'item': hmod.Item.objects.get(id=8)},
    {'condition': 'Like New', 'late_fee': '50.00', 'due_date': '2015-2-12', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=9), 'item': hmod.Item.objects.get(id=9)},
    {'condition': 'Used', 'late_fee': '500.00', 'due_date': '2015-2-19', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=10), 'item': hmod.Item.objects.get(id=11)},
    {'condition': 'Used', 'late_fee': '22.00', 'due_date': '2015-3-1', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=11), 'item': hmod.Item.objects.get(id=10)},
    {'condition': 'Like New', 'late_fee': '1.00', 'due_date': '2014-3-1', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=12), 'item': hmod.Item.objects.get(id=12)},
    {'condition': 'Like New', 'late_fee': '50.00', 'due_date': '2014-3-1', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=13), 'item': hmod.Item.objects.get(id=4)},
    {'condition': 'Like New', 'late_fee': '50.00', 'due_date': '2014-3-1', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=14), 'item': hmod.Item.objects.get(id=8)},
    {'condition': 'Like New', 'late_fee': '500.00', 'due_date': '2014-12-12', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=15), 'item': hmod.Item.objects.get(id=2)},
    {'condition': 'Used', 'late_fee': '45.00', 'due_date': '2014-12-19', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=16), 'item': hmod.Item.objects.get(id=3)},
    {'condition': 'Like New', 'late_fee': '50.00', 'due_date': '2014-12-26', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=17), 'item': hmod.Item.objects.get(id=6)},
    {'condition': 'Like New', 'late_fee': '500.00', 'due_date': '2014-12-26', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=18), 'item': hmod.Item.objects.get(id=5)},
    {'condition': 'Like New', 'late_fee': '23.00', 'due_date': '2015-1-3', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=19), 'item': hmod.Item.objects.get(id=4)},
    {'condition': 'Used', 'late_fee': '56.00', 'due_date': '2015-1-3', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=20), 'item': hmod.Item.objects.get(id=9)},
    {'condition': 'Like New', 'late_fee': '576.00', 'due_date': '2015-1-3', 'new_damage': 'False',  'damage_fee': '10.00', 'rental': hmod.Rental.objects.get(id=21), 'item': hmod.Item.objects.get(id=11)},
]:
...
for data in [
    ...
    {'name': 'Presidential Stamp', 'description': 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.', 'low_price': '25', 'high_price': '53', 'artisan_name': hmod.User.objects.get(id=6), 'area': hmod.Area.objects.get(id=4), 'photo': 'si10.jpg'},
